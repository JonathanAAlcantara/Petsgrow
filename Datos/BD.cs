...
namespace Datos
{
    public class BD
    {
        ...
        public BD()
        {
            //connectionString = ConfigurationManager.ConnectionStrings["BDFelipeArcos"].ToString();
            connectionString = ConfigurationManager.ConnectionStrings["petsgwmxBDCore"].ToString();
        }
